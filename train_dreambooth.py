        ...
        if args.use_lora:
            ...
            if args.train_text_encoder:
                ...
                unwarpped_text_encoder.save_pretrained(
                    os.path.join(args.output_dir, "text_encoder"), state_dict=accelerator.get_state_dict(text_encoder)
                )
                # torch.save(
                #     accelerator.get_state_dict(text_encoder),
                #     os.path.join(args.output_dir, "text_encoder/text_encoder.pt"),
                # )
        else:
            pipeline = DiffusionPipeline.from_pretrained(
                args.pretrained_model_name_or_path,
